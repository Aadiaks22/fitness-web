...
import { getDemoBookings, deleteDemoBooking } from "@/app/actions/form-actions"
...
export default async function BookingsPage() {
  ...
  const { success, bookings, error } = await getDemoBookings()
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-custom-deep-blue">Demo Bookings</h2>
        ...
        {!success ? (
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <p className="text-custom-text text-lg">No demo bookings yet.</p>
          </div>
        ) : (
          <BookingList bookings={bookings} deleteBooking={deleteDemoBooking} />
        )}
      </main>
