...
import { getLeads, deleteLead } from "@/app/actions/form-actions"
...
export default async function LeadsPage() {
  ...
  const { success, leads, error } = await getLeads()
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-custom-deep-blue">Popup Form Leads</h2>
        ...
        {!success ? (
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <p className="text-custom-text text-lg">No popup form leads yet.</p>
          </div>
        ) : (
          <LeadsList leads={leads} deleteLead={deleteLead} />
        )}
      </main>
